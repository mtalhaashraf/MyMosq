              ...
              <li class="ninjadash-tasklist-item d-flex align-items-center justify-content-between">
                <div class="ninjadash-tasklist-item__content">
                  <div class="ninjadash-tasklist-item__title">
                    <div
                      class="checkbox-theme-default custom-checkbox custom-checkbox--success checkbox-group__single d-flex p-0 form-check"
                    >
                      <input
                        placeholder=""
        ...
        {#if completed.length}
          <ul class="ninjadash-tasklist">
            {#each $todos.filter((item) => item.completed) as todo}
              {#if !todo.trash}
                <li
                  class="ninjadash-tasklist-item d-flex align-items-center justify-content-between"
                >
                  <div class="ninjadash-tasklist-item__content">
                    <div class="ninjadash-tasklist-item__title">
                      <div class="checkbox-group d-flex" on:change={() => todos.toggle(todo)}>
                        <div
                          class="checkbox-theme-default custom-checkbox custom-checkbox--success checkbox-group__single d-flex"
                        >
                          <input
                            class="checkbox"
                            type="checkbox"
