    ...
    <div class="card job job--grid">
      <div class="h-100">
        <div class="job-item px-25 pt-30 pb-25">
          <div
            class="card-body p-0 d-flex align-items-sm-center align-items-start flex-sm-row flex-column flex-wrap"
          >
            ...
            <div class="job-item__button d-flex flex-wrap my-sm-0 my-10">
              <button class="btn btn-default btn-squared color-none btn-outline-none px-20"
                >View details
              </button>
            </div>
          </div>
